...
players.append(Football('Cory Lasconk','DE',850000,27))
players.append(Football('P.J. Langford','WR',1900000,31))
players.append(Football('Ralston Rivers','DT',1100000,32))
...
Football.addplayer('Jeff Woal','LB',9823000,30)
print(len(players))
